...
export function LoadingScreen({
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950 flex items-center justify-center relative overflow-hidden px-6 py-12">
      {/* Background Pattern */}
